...
/**
 * @ORM\Table(name="oro_report_mage_order_store", indexes={@ORM\Index(name="IDX_STORE", columns={"store_id"}), @ORM\Index(name="IDX_CREATED", columns={"created_at"})})
 * @ORM\Entity
 */
class ReportMageOrderStore
{
    /**
     * @var integer
     *
     ...
     * @var integer
     *
     * @ORM\Column(name="store_id", type="smallint", nullable=true)
     */
    protected $storeId;
