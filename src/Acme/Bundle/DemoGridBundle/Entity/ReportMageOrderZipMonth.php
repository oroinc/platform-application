...
/**
 * @ORM\Table(name="oro_report_mage_order_zip_month", indexes={@ORM\Index(name="IDX_COUNTRY_ZIP", columns={"country", "zip"}), @ORM\Index(name="IDX_YEAR_MONTH", columns={"year", "month"})})
 * @ORM\Entity
 */
