...
/**
 * Tests for the simple customer Segment controller
 *
 * @author    Benoit Jacquemont <benoit@akeneo.com>
 * @copyright 2012 Akeneo SAS (http://www.akeneo.com)
 * @license   http://opensource.org/licenses/MIT MIT
 */
class SimpleCustomerSegmentControllerTest extends WebTestCase
{
    protected $client;
    ...
    public function setUp()
    {
        ...
        $fixturesPath = $kernel->locateResource('@AcmeDemoSegmentationTreeBundle/Tests/Functional/DataFixtures/ORM/SimpleCustomerSegment/');
        $options = array(
            '--force' => null
        );
    ...
    public function testGetChildren()
    {
        $this->client->request(
            'GET',
            '/segmentation-tree/simple-customer-segment/children',
            array(),
            array(),
            array(
        ...
        $this->assertEquals('[{"attr":{"id":"node_3","rel":"folder"},"data":"Customers","state":"closed"},{"attr":{"id":"node_1","rel":"folder"},"data":"Prospects","state":"closed"}]',$response->getContent());
    }
