...
/**
 * @ORM\Table(name="oro_report_mage_order_customer", indexes={@ORM\Index(name="IDX_CUSTOMER_ID", columns={"customer_id"}), @ORM\Index(name="IDX_CREATED", columns={"created_at"})})
 * @ORM\Entity
 */
