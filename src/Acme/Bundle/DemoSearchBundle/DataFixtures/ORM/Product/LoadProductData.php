<?php
namespace Acme\Bundle\DemoSearchBundle\DataFixtures\ORM\Product;
...
use Acme\Bundle\DemoSearchBundle\Entity\ProductAttribute;
...
*
*/
class LoadSearchProductData extends AbstractFixture implements OrderedFixtureInterface, ContainerAwareInterface
{
    ...
    {
        return $this->container->get('search_product_manager');
    }
